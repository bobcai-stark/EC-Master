...
\EC_REFBOARD_EMLLDPDK NXP Layerscape 1046A
\EC_REFBOARD_EMLLDPDK Intel Ethernet Network Adapter X710
\EC_REFBOARD_EMLLDPDK Intel Ethernet-Controller I210
    ...
    EC_T_LINK_PARMS** ppLinkParms)
{
    ...
    else
    {
        ...
        else if (0 == OsStricmp(*ptcWord, "rzn2h")) /**< \EC_REFBOARD_EMLLDW3504 Renesas RZ/N2H */
        {
        	pLinkParmsAdapter->eDW3504Type = eDW3504_RZN2;
            ...
            if (pLinkParmsAdapter->linkParms.dwInstance == 1)
            {
                pLinkParmsAdapter->dwRegisterBasePhys = 0x80100000;
                pLinkParmsAdapter->dwPhyAddr = 1;
            }
            else if (pLinkParmsAdapter->linkParms.dwInstance == 2)
            {
                pLinkParmsAdapter->dwRegisterBasePhys = 0x92000000;
                pLinkParmsAdapter->dwPhyAddr = 2;
            }
            else if (pLinkParmsAdapter->linkParms.dwInstance == 3)
            {
                pLinkParmsAdapter->dwRegisterBasePhys = 0x92010000;
                pLinkParmsAdapter->dwPhyAddr = 3;
            }
            else
            {
                EcLogMsg(EC_LOG_LEVEL_ERROR, (pEcLogContext, EC_LOG_LEVEL_ERROR, "Instance number must be 1, 2 or 3\n"));
                dwRetVal = EC_E_INVALIDPARM;
                goto Exit;
            }
        }
        ...
        else if (0 == OsStricmp(*ptcWord, "t536eval")) /**< \EC_REFBOARD_EMLLDW3504 Allwinner T536 Evalboard */
        {
            pLinkParmsAdapter->eDW3504Type = eDW3504_AllWinnerT536;
            pLinkParmsAdapter->ePhyInterface = ePHY_RGMII;
            pLinkParmsAdapter->dwPhyAddr = 1;
            if (pLinkParmsAdapter->linkParms.dwInstance == 1)
            {
                pLinkParmsAdapter->dwRegisterBasePhys = 0x04500000;
            }
            else if (pLinkParmsAdapter->linkParms.dwInstance == 2)
            {
                pLinkParmsAdapter->dwRegisterBasePhys = 0x04510000;
            }
            else
            {
                EcLogMsg(EC_LOG_LEVEL_ERROR, (pEcLogContext, EC_LOG_LEVEL_ERROR, "Instance number must be 1 or 2\n"));
        ...
        else if (0 == OsStricmp(*ptcWord, "custom"))
        {
            ...
            *ptcWord = GetNextWord(lpCmdLine, tcStorage);
            ...
            else if (0 == OsStricmp(*ptcWord, "rk3506"))
            {
                pLinkParmsAdapter->eDW3504Type = eDW3504_RK3506;
                if (pLinkParmsAdapter->linkParms.dwInstance == 1)
                {
                    pLinkParmsAdapter->dwRegisterBasePhys = 0xFF4C8000;
                }
                else if (pLinkParmsAdapter->linkParms.dwInstance == 2)
                {
                    pLinkParmsAdapter->dwRegisterBasePhys = 0xFF4D0000;
                }
                else
                {
                    EcLogMsg(EC_LOG_LEVEL_ERROR, (pEcLogContext, EC_LOG_LEVEL_ERROR, "Instance number must be 1 or 2\n"));
            ...
            else if (0 == OsStricmp(*ptcWord, "allwinnert536"))
            {
                pLinkParmsAdapter->eDW3504Type = eDW3504_AllWinnerT536;
                if (pLinkParmsAdapter->linkParms.dwInstance == 1)
                {
            ...
            else if (0 == OsStricmp(*ptcWord, "allwinnert527"))
            {
                pLinkParmsAdapter->eDW3504Type = eDW3504_AllWinnerT527;
                if (pLinkParmsAdapter->linkParms.dwInstance == 1)
                {
                    pLinkParmsAdapter->dwRegisterBasePhys = 0x04500000;
                }
...
EC_T_LINK_PARMS_FSLFEC* pLinkParmsAdapter = EC_NULL;
    ...
    *ptcWord = GetNextWord(lpCmdLine, tcStorage);
    ...
    else if (0 == OsStricmp(*ptcWord, "imx8mpluspd4-evk")) /**< \EC_REFBOARD_EMLLFSLFEC NXP 8MPLUSPD4-EVK board */
    {
    ...
    else if (0 == OsStricmp(*ptcWord, "yv-520010-et-xmn")) /**< \EC_REFBOARD_EMLLFSLFEC custom YV-520010-ET-XMN board */
    {
        pLinkParmsAdapter->eFecType = eFEC_IMX8MP;
        pLinkParmsAdapter->ePhyInterface = ePHY_RMII;
        if (pLinkParmsAdapter->linkParms.dwInstance == 1)
...
EC_T_BOOL bGetNextWord = EC_TRUE;
    ...
    *ptcWord = GetNextWord(lpCmdLine, tcStorage);
    ...
    else if ((EC_NULL != *ptcWord) && ((0 == OsStricmp(*ptcWord, "kr260")))) /**< \EC_REFBOARD_EMLLGEM Xilinx Kria KR260 Robotics Starter Kit */
    {
        ...
        /* instance 1 only with Linux and ePHY_OSDRIVER,
         *    gets dwPhyAddr and ePHY_SGMII from device tree  */
...
static EC_T_BOOL IsPciLocation(const EC_T_CHAR* parmStr)
{
...
EC_T_VOID ShowSyntaxLinkLayer(EC_T_VOID)
{
    ...
    EcLogMsg(EC_LOG_LEVEL_ERROR, (pEcLogContext, EC_LOG_LEVEL_ERROR, "     Mode            Interrupt (0) or Polling (1) mode\n"));
    EcLogMsg(EC_LOG_LEVEL_ERROR, (pEcLogContext, EC_LOG_LEVEL_ERROR, "    [RefBoard:       intel_atom | lces1 | lubancat3 | myd-jd9x | orangepi4 | orangepi5 | r12ccpu | rd55up06 | rock3 | rock64 | rzn1 | rzn2h | socrates | stm32mp135f-dk | stm32mp157a-dk1 | t536eval | tl-3576-evm | WagoCC100 | custom\n"));
    EcLogMsg(EC_LOG_LEVEL_ERROR, (pEcLogContext, EC_LOG_LEVEL_ERROR, "     if custom        DW3504Type: allwinnert527 | allwinnert536 | cycloneV | intel_atom | lces1 | rk3328 | rk3399 | rk3506 | rk3562 | rk3568 | rk3576 | rk3588s  | semidrive-d9 | stm32mp157a-dk1 | stm32mp135\n"));
    ...
    EcLogMsg(EC_LOG_LEVEL_ERROR, (pEcLogContext, EC_LOG_LEVEL_ERROR, "     Instance        Device instance (1=first), e.g. 1\n"));
    EcLogMsg(EC_LOG_LEVEL_ERROR, (pEcLogContext, EC_LOG_LEVEL_ERROR, "     Mode            Interrupt (0) or Polling (1) mode\n"));
    EcLogMsg(EC_LOG_LEVEL_ERROR, (pEcLogContext, EC_LOG_LEVEL_ERROR, "    [RefBoard:       mars | sabrelite | sabresd | imx28evk | topaz | imxceetul2 | mimxrt1064-evk | imx93evk | imx8mpluspd4-evk | yv-520010-et-xmn | custom\n"));
